  ...
  return (
    <div className="Job">
      ...
      <List>
        ...
        <ListItem>Led Trustly payment integration and licensing from technical side.</ListItem>
      </List>
      <h2>FuboTV</h2>
      <List>
        <ListItem>Pushed along process improvements, standards improvements, and modernization of code practices.</ListItem>
        <ListItem>Performed large overhaul of remote control focus system.</ListItem>
        <ListItem>Contributed heavily to several features of application rewrite, including the navigation sidebar and playback controls.</ListItem>
        <ListItem>Sped up development efficiency in key areas including VOD Playback & Client Side Ad Insertion (CSAI)</ListItem>
      </List>
    </div>
  );
}
